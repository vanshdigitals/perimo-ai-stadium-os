...
import { LayoutDashboard, AlertTriangle, UsersRound, HelpCircle } from 'lucide-react'
...
const NAV_GROUPS = [
  {
    label: '',
    items: [
      { label: 'Staff Dashboard', icon: LayoutDashboard, path: '/staff' },
      { label: 'Active Incidents', icon: AlertTriangle, path: '/staff/incidents' },
      { label: 'Staff Map', icon: UsersRound, path: '/staff/map' },
    ]
  }
]
